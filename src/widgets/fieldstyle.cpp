...
FieldStyle::FieldStyle(std::optional<double> padding_percent,
    ...
    padding_percent(padding_percent.value_or(FieldStyle::DEFAULT_PADDING_PERCENT)),
    ...
    std::string explosion_path = explosion.value_or(FieldStyle::DEFAULT_EXPLOSION);
